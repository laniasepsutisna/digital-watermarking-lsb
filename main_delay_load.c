 ...
 */
FARPROC WINAPI mainDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = mainDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = mainDelayLoadWin32FailureHook;
#endif
